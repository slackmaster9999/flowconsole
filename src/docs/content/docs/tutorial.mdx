...
There are several types of interfaces you can use, such as `ReactApp`, `RestApi`, `Postgres`, etc.
For a complete list of available interfaces and methods, check out the [API Reference](./config/api-reference.mdx).
